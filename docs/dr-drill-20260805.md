...
Generado por `node scripts/backup/dr-drill.mjs` en 111 s. Este archivo lo escribe
...
- **Destino:** contenedor efimero `dermaland-dr-db` (`supabase/postgres:17.6.1.132`) en `cibaocloud@supabase-01`, sin puerto expuesto,
  cluster `7670735928061505570` — distinto del de origen, comprobado antes de comparar.
...
- Destino (arenero):    cluster 7670735928061505570 · Postgres 17.6
