# Simulacro de recuperacion — 2026-08-06

**Veredicto: PASA**

Generado por `node scripts/backup/dr-drill.mjs` en 68 s. Este archivo lo escribe
...
- **Destino:** contenedor efimero `dermaland-dr-db` (`supabase/postgres:17.6.1.132`) en `cibaocloud@supabase-01`, sin puerto expuesto,
  cluster `7670798206527078439` — distinto del de origen, comprobado antes de comparar.
...
- Destino (arenero):    cluster 7670798206527078439 · Postgres 17.6
- Destino verificado: 0 relaciones en public, aislado y desechable.
