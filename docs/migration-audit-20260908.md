# Auditoria de migraciones — 2026-09-08
...
| `0008_security_advisor_fixes` | PARCIAL | 20 | si | policy:users.users_ins, policy:users.users_upd, policy:users.users_del |
...
| `20260906120000_alegra_vendedor` | APLICADA | 2 | si | — |
| `20260906130000_resumen_ventas_unificadas` | APLICADA | 1 | si | — |
| `20260906140000_desglose_ventas_unificadas` | APLICADA | 2 | si | — |
| `20260907120000_desglose_ventas_sucursal_mes` | APLICADA | 1 | si | — |
| `20260907140000_resumen_ventas_itbis_items` | APLICADA | 1 | si | — |
| `20260907160000_metricas_clientes_unificadas` | APLICADA | 1 | si | — |
| `20260907180000_resumen_ventas_descuento_clientes` | APLICADA | 1 | si | — |
| `20260907200000_sucursal_vendedor_por_defecto` | APLICADA | 1 | si | — |
| `20260907220000_incentivos_desde_alegra` | APLICADA | 3 | si | — |
| `20260908100000_billing_settings_tipo_cliente` | NO_APLICADA | 1 | **NO** | column:billing_settings.default_customer_billing_type |
| `20260908174608_referencias_de_usuario` | APLICADA | 1 | si | — |
| `20260908175750_panel_ventas_unificadas` | APLICADA | 1 | si | — |
| `20260909100000_cuentas_de_acceso` | APLICADA | 15 | si | — |
| `20260909100200_boveda_trigger_auth_users` | APLICADA | 1 | si | — |
| `20260909110000_ventas_por_laboratorio` | APLICADA | 1 | si | — |
| `20260909120000_resumen_inventario_panel` | APLICADA | 1 | si | — |
| `20260909130000_bajo_minimo_solo_configurados` | APLICADA | 1 | si | — |
| `20260909140000_pagina_clientes` | APLICADA | 1 | si | — |
...
- `20260908100000_billing_settings_tipo_cliente` → NO_APLICADA
...
- `0008_security_advisor_fixes` → PARCIAL. Revisar a mano antes de tocar el historial.
