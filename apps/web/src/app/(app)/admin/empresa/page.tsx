    ...
    <>
      ...
      <Card>
        <CardContent>
          ...
          <FormSection
            title="Branding"
            description="Logos en PNG/SVG (192×192, 512×512). Tokens CSS configurables."
          >
            <div className="grid gap-4 sm:grid-cols-2">
              <div>
                <Label>Eslogan</Label>
                <Input defaultValue="Venta de Productos Dermatológicos" />
              </div>
              <div>
            ...
            <div>
              ...
              <Textarea
                defaultValue="Plataforma SaaS multiempresa para farmacia, dermocosmética y cuidado dermatológico. República Dominicana."
              />
            </div>
          </FormSection>
