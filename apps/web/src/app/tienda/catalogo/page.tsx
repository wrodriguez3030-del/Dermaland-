 ...
 * —los resultados de búsqueda van `noindex`, la portada no—. Tenerlas en la
 * misma dirección obligaba a que una sola URL fuera dos páginas según llevara o
 * no parámetros.
 *
 ...
 * de verdad interesan.
 *
 * Los filtros por marca SÍ se indexan: son colecciones reales y estables, con su
 * propia URL canónica. Las categorías tienen además su propia página.
 */
    ...
    <>
      <section className="mb-8">
        <h1 className="text-2xl font-bold tracking-tight text-[color:var(--brand-fg)] sm:text-3xl">
          {filtrado ? "Resultados" : "Todo el catálogo"}
        </h1>
