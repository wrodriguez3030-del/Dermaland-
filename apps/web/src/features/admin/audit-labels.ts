...
const ACTION_LABELS: Record<string, string> = {
  ...
  "storefront.disabled": "Tienda en línea apagada",
  "storefront.enabled": "Tienda en línea encendida",
  "storefront.product_content_update": "Ficha web del producto actualizada",
  "storefront.product_published": "Producto publicado en la tienda",
  "storefront.product_unpublished": "Producto retirado de la tienda",
  "storefront.products_published": "Productos publicados en lote",
  "storefront.products_unpublished": "Productos retirados en lote",
  "storefront.settings_update": "Configuración de la tienda actualizada",
