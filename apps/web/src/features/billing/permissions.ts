...
export function isBillingAdmin(role: UserRole): boolean {
...
export function canEditSales(role: UserRole): boolean {
...
export function canViewIncentives(_role: UserRole): boolean {
  return true;
}
...
export function canPayIncentives(role: UserRole): boolean {
