...
export const mockAIAgents: AIAgent[] = [
  {
    ...
    systemPrompt: [
      ...
      "- search_products: buscar productos por nombre o SKU (devuelve 'disponibles' con stock y precio, y 'agotados').",
      ...
      "- get_receivables: cuentas por cobrar — view: summary (total pendiente/vencido/morosos/recuperación), top_debtors (quiénes deben más), due_today (vencen hoy), overdue_60 (más de 60 días), collected_week (cobrado esta semana), by_seller (crédito por vendedor).",
